...
**Project**: 3d-protein-connector 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: criar uma imagem em 3d de um ligação proteica 
...
```sh
git clone https://github.com/GPT-Engineer-App/3d-protein-connector.git
cd 3d-protein-connector
npm i
